...
const spkBodyBase = z.object({
  ...
  kasbonSebelumTermin2: emptyAsUndefined(z.coerce.number().nonnegative().optional()),
  kasbonSebelumTermin3: emptyAsUndefined(z.coerce.number().nonnegative().optional()),
  kasbonSebelumTermin4: emptyAsUndefined(z.coerce.number().nonnegative().optional()),
  bankRekeningPtId: emptyAsUndefined(z.coerce.number().int().positive().optional()),
  nilaiBisaDitagihkan: emptyAsUndefined(z.coerce.number().nonnegative().optional()),
