...
import { seedPenjualanBatal } from "./seeds/seedPenjualanBatal.ts";
import { updateRekeningKavlingTest } from "./seeds/kavlingUpdateKsoSeed.ts";
...
async function main() {
  ...
  // seedTagihan(prisma);
  // seedPenjualanBatal(prisma)
  updateRekeningKavlingTest(prisma)
