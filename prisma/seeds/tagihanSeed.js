...
exports.seedTagihan = seedTagihan;
var client_1 = require("@prisma/client");
function seedTagihan(prisma) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.tagihan.createMany({
                        data: [
                            {
                                ...
                                status: client_1.PaymentStatus.LUNAS,
                            ...
                            },
                            {
                                ...
                                status: client_1.PaymentStatus.BELUM_BAYAR,
