...
exports.seedProgressProyek = seedProgressProyek;
var client_1 = require("@prisma/client");
function seedProgressProyek(prisma) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.progressProyek.createMany({
                        data: [
                            {
                                kavlingId: 1,
                                ...
                                status: client_1.ProgressStatus.DISETUJUI,
                            },
                            {
                                kavlingId: 1,
                                pelaksana: "H. Mandor Surya",
                                ...
                                status: client_1.ProgressStatus.MENUNGGU_VERIFIKASI,
                            },
                        ],
                    })];
                case 1:
